    ...
    render() {
        ...
        return (
            <Form id="main_form" className="main-form" onSubmit={this.handleSubmit}>
                ...
                <PatientInfo handleChange={this.handleChange} patientName={this.state.patientName} patientID={this.state.patientID} age={this.state.age} gender={this.state.gender} />
